        ...
        protected void EditBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    Query = string.Format(Query, CName, CDesc, CatNameTb.Value = CategoriesList.SelectedRow.Cells[1].Text);
                    Con.SetData(Query);
                    ShowCategories();
        ...
        protected void deleteBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    Query = string.Format(Query, CatNameTb.Value = CategoriesList.SelectedRow.Cells[1].Text);
                    Con.SetData(Query);
                    ShowCategories();
